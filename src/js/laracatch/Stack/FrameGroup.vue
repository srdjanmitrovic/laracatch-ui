<template>
    ...
    >
        <div class="stack-frame | cursor-pointer">
            <button class="stack-frame-number focus:shadow-outline">
                <i class="fas fa-plus-circle text-gray-500" />
            </button>
            <div class="span-2 stack-frame-text">
                <button class="text-left text-gray-500" tabindex="-1">
                    {{
    ...
    >
        <div class="stack-frame">
            <div class="stack-frame-number"></div>
            <div class="span-2 stack-frame-text">
            ...
            >
                ...
                <div class="stack-frame-text">
                    ...
                    >
                        <FilePath
                            :pathClass="
                                frameGroup.type === 'vendor' ? 'text-gray-700' : 'text-gray-800'
                            "
                ...
                <div class="pl-2 pr-1 py-4 text-right">
